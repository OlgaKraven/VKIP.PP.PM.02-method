...
Отслеживание = регулярное снятие метрик + сохранение результатов + реакция на пороговые значения. На ДЭ профильного уровня этот критерий имеет максимальный вес — **25 баллов из 100**.
